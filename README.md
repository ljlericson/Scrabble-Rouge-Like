...
4. Run `cd ..` to go back to the root directory and then run the desired generate shell/batch script (note that on Linux/Mac you must run like so: `sh <desired generation>.sh`)
